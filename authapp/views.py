...
def register(request):
    ...
    if request.method == 'POST':
        ...
        if register_form.is_valid():
            ...
            return HttpResponseRedirect(reverse('authapp:email_verification'))
...
def edit(request):
    ...
    context = {'title': title, 'form': edit_form, 'profile_form': profile_form, 'user_profile': request.user.shopuserprofile}
